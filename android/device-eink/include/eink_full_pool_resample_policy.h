...
// B002's only active response to a proven full-pool condition. It owns no
// pixels, buffers, fences, or threads. The Android seam supplies one later
...
class FullPoolResamplePolicy final {
 public:
  ...
  // the Android owner for one normal composition. Expiry changes only the
