...
// The system-chrome edge in post-conversion capture coordinates. The current
// locks the current configured source capture to its measured lower edge;
...
// The bounded full-frame micro-delta policy. This has no device-update or
