...
using einklab::ConvertToGrayscale;
using einklab::MeasureGrayscaleDelta;
using einklab::Rect;
using einklab::RgbaLayout;
using einklab::RgbaSource;
using einklab::Rotation;
using einklab::TransformRect;
...
std::shared_ptr<einklab::OwnedGrayscaleBuffer> ConvertOpaqueGray(
